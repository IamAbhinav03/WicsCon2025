...
<div className="space-y-6">
  ...
  <p className="text-gray-400 leading-relaxed md:text-left text-center">
    The premier conference for women in computing and technology. Join us in fostering diversity, 
    innovation, and excellence in the tech industry.
  </p>
  <div className="flex md:justify-start justify-center space-x-4">
    <a href="https://x.com/wics_ashoka" 
    ...
    <a href="https://www.linkedin.com/company/wics-ashoka-university" 
       className="bg-gray-800 p-2 rounded-full hover:bg-red-600 transition-colors">
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
        <path fillRule="evenodd" d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z" clipRule="evenodd"/>
      </svg>
    </a>
    <a href="https://www.instagram.com/wics.ashoka/" 
       className="bg-gray-800 p-2 rounded-full hover:bg-red-600 transition-colors">
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
  ...
  <div className="grid grid-cols-3 md:grid-cols-2 gap-4 md:space-y-4">
    {[
      ...
      <div>
        ...
        <a href="https://www.google.com/maps?ll=28.946989,77.101449&z=14&t=m&hl=en&gl=US&mapclient=embed&cid=543259652471321703" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-red-500 transition-colors">
        ...
        <a href="mailto:wics@ashoka.edu.in" className="text-gray-400 hover:text-red-500 transition-colors">
          wics@ashoka.edu.in
        </a>
          </div>
          <div className="flex items-center space-x-3">
        ...
        <a href="tel:+919947104672" className="text-gray-400 hover:text-red-500 transition-colors">
          +91 99471 04672
        </a>
          </div>
        </div>
